                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <?php
                                ...
                                $filedType = ($this->input->get('view', '', 'cmd') == 'settings' && $field->attributes->type == 'textext') ? 'text' : $field->attributes->type;
                            ?>
                            <?php echo $this->output('admin/form/field.' . $filedType, array('field' => $field, 'default' => $defaultVal, 'prefix' => $prefix)); ?>
                        </div>
                    </div>
