            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="page_title" class="col-md-5">
                        ...
                        <i data-html="true" data-placement="top" data-title="<?php echo JText::_('COM_EASYBLOG_SETTINGS_COMMENTS_ENABLE_GUEST_COMMENT'); ?>"
                            data-content="<?php echo JText::_('COM_EASYBLOG_SETTINGS_COMMENTS_ENABLE_GUEST_COMMENT_DESC');?>" data-eb-provide="popover" class="fa fa-question-circle pull-right"></i>
                    </label>

                    <div class="col-md-7">
                    	<?php echo $this->html('grid.boolean', 'main_allowguestcomment', $this->config->get('main_allowguestcomment')); ?>
                    </div>
                </div>
