...
?>
<div class="row">
	<div class="col-lg-6 <?php echo $this->config->get('main_routing') == 'default' ? ' hide' : '';?>">
		<div class="panel">
	                ...
	                <div class="col-md-9">
						<div class="list-group">
							...
							<div class="list-group-item">
								<div class="radio">
									<input type="radio" name="main_routing" value="default" id="defaultRouting" data-routing-type <?php echo $this->config->get('main_routing') == 'default' ? ' checked="checked"' : '';?> style="margin-top: 2px;" />
							...
							<div class="list-group-item">
								<div class="radio">
									<input type="radio" name="main_routing" value="currentactive" id="currentRouting" data-routing-type <?php echo $this->config->get('main_routing') == 'currentactive' ? ' checked="checked"' : '';?> style="margin-top: 2px;" />
									<label for="currentRouting">
										<b class="list-group-item-heading"><?php echo JText::_('COM_EASYBLOG_SETTINGS_WORKFLOW_ROUTING_BEHAVIOR_USE_CURRENT_ACTIVEMENU');?></b>
										<p class="list-group-item-text">
											<?php echo JText::_('COM_EASYBLOG_SETTINGS_WORKFLOW_ROUTING_BEHAVIOR_USE_CURRENT_ACTIVEMENU_DESC');?>
										</p>
									</label>
								</div>
							</div>
							...
							<div class="list-group-item">
								<div class="radio">
									<input type="radio" name="main_routing" value="menuitemid" id="useMenuRouting" data-routing-type <?php echo $this->config->get('main_routing') == 'menuitemid' ? ' checked="checked"' : '';?> style="margin-top: 2px;" />
