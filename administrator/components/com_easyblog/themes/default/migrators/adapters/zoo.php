...
<div class="row">
	<div class="col-lg-6">
		<div class="panel">
			<div class="panel-body"><?php echo JText::_('COM_EASYBLOG_MIGRATOR_ZOO_COMPONENT_NOT_FOUND'); ?></div>
		</div>
	</div>
</div>
<?php } else { ?>
	...
	<div class="col-lg-6">
		<div class="panel">
			<div class="panel-head">
				<div class="panel-info"><?php echo JText::_('COM_EASYBLOG_MIGRATOR_ZOO_IMPORT_NOTICE'); ?></div>
			</div>

			<div class="panel-body">
				<div class="form-group">
					<label for="page_title" class="col-md-5">
						<?php echo JText::_('COM_EASYBLOG_MIGRATOR_ZOO_APPLICATION_ID'); ?>

						<i data-html="true" data-placement="top" data-title="<?php echo JText::_('COM_EASYBLOG_MIGRATOR_ZOO_APPLICATION_ID'); ?>"
							data-content="<?php echo JText::_('COM_EASYBLOG_MIGRATOR_ZOO_APPLICATION_ID_DESC');?>" data-eb-provide="popover" class="fa fa-question-circle pull-right"></i>
					</label>
