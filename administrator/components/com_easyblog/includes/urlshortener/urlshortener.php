...
{
	public function get_short_url($login, $apikey, $url, $provider='bitly')
	{
		$function = "make_".$provider."_url";
		return $this->$function($login, $apikey, $url, 'json');
	}

	public function make_bitly_url($login, $apikey, $url, $format='json')
	{
	...
	public function make_short_url($restURL)
	{
