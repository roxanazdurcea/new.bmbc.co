...
<form action="<?php echo $_SERVER['REQUEST_URI']?>" method="post" class="wrap" id="ls-slider-form" novalidate="novalidate">
	...
	<h2>
		...
		<a href="?option=com_layer_slider" class="add-new-h2"><?php _e('Back to the list', 'LayerSlider') ?></a>
	</h2>
												...
												<table>
													<tbody>
														...
														<tr>
															...
															<td colspan="1"><input type="checkbox" name="wordwrap" data-help="<?php _e('If you use custom sized layers, you have to enable this setting to wrap your text.', 'LayerSlider') ?>" class="checkbox"<?php echo isset($sublayer['wordwrap']) ? ' checked="checked"' : '' ?>></td>
