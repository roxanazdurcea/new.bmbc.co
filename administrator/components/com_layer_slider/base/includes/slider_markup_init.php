...
if(get_option('ls_put_js_to_body', false)) {
    ...
    $data[] = '<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/gsap/1.11.2/TweenMax.min.js"></script>' . NL;
}

$data[] = '<script type="text/javascript">' . NL;
	$data[] = '(window.jq183||jQuery)(document).ready(function($) {' . NL;
