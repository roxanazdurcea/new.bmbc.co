...
$document->addStyleSheet(JURI::base() . '/components/com_layer_slider/base/static/css/dashicons.css');
$document->addStyleSheet(JURI::base() . '/components/com_layer_slider/assets/css/wp_specs.css');
$document->addStyleSheet(JURI::base() . '/components/com_layer_slider/base/static/css/global.css');
$document->addStyleSheet(JURI::base() . '/components/com_layer_slider/base/static/css/admin.css');
$document->addStyleSheet(JURI::base() . '/components/com_layer_slider/base/static/css/admin_new.css');
$document->addStyleSheet(JURI::base() . '/components/com_layer_slider/base/static/css/layerslider.css');
$document->addStyleSheet(JURI::base() . '/components/com_layer_slider/base/static/css/layerslider.transitiongallery.css');
$document->addStyleSheet(JURI::base() . '/components/com_layer_slider/base/static/js/minicolors/jquery.minicolors.css');
...
$document->addScript(JURI::base() . '/components/com_layer_slider/base/static/js/admin.js');
$document->addScript(JURI::base() . '/components/com_layer_slider/base/static/js/builder.js');
$document->addScriptDeclaration("jQuery.ui.slider.prototype.widgetEventPrefix = 'slider';");
$document->addScript(JURI::base() . '/components/com_layer_slider/base/static/js/layerslider.kreaturamedia.jquery.js');
$document->addScript(JURI::base() . '/components/com_layer_slider/base/static/js/layerslider.transitions.js');
$document->addScript('https://cdnjs.cloudflare.com/ajax/libs/gsap/1.11.2/TweenMax.min.js');
$document->addScript(JURI::base() . '/components/com_layer_slider/base/static/js/layerslider.transition.gallery.js');
$document->addScript(JURI::base() . '/components/com_layer_slider/base/static/js/minicolors/jquery.minicolors.js');


// 3rd-party: CodeMirror
$document->addStyleSheet(JURI::base() . '/components/com_layer_slider/base/static/codemirror/lib/codemirror.css');
$document->addStyleSheet(JURI::base() . '/components/com_layer_slider/base/static/codemirror/theme/solarized.mod.css');

$document->addScript(JURI::base() . '/components/com_layer_slider/base/static/codemirror/lib/codemirror.js');
$document->addScript(JURI::base() . '/components/com_layer_slider/base/static/codemirror/mode/css/css.js');
$document->addScript(JURI::base() . '/components/com_layer_slider/base/static/codemirror/mode/javascript/javascript.js');
$document->addScript(JURI::base() . '/components/com_layer_slider/base/static/codemirror/addon/fold/foldcode.js');
$document->addScript(JURI::base() . '/components/com_layer_slider/base/static/codemirror/addon/fold/foldgutter.js');
$document->addScript(JURI::base() . '/components/com_layer_slider/base/static/codemirror/addon/fold/brace-fold.js');
$document->addScript(JURI::base() . '/components/com_layer_slider/base/static/codemirror/addon/selection/active-line.js');


if (!defined('LS_ROOT_PATH')) define("LS_ROOT_PATH", JPATH_COMPONENT."/base/");
if (!defined('LS_ROOT_URL')) define("LS_ROOT_URL", JURI::root()."administrator/components/com_layer_slider/base/" );

require_once JPATH_COMPONENT.'/base/wp/hooks.php';
require_once JPATH_COMPONENT.'/base/classes/class.ls.sliders.php';
