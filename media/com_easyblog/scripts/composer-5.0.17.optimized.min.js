...
var i,e=a(j),f=a(k),h=0;e.show(),b.find(m).each(function(){var b=a(this),e=b.find("img"),j=b.find(g),k=e.attr("src"),l=j.attr("href"),m=a(d).attr("data-url",l).find("img").attr("src",k).end().appendTo(f);h+=m.outerWidth(!0),b[0]==c[0]&&(i=m)}),f.css("width",h),u.openPopupThumb(i)},openImage:function(a){u.open();var b=a.find(o),c=a.find(g),d=c.attr("href"),e=b.text();e||(e=c.attr("title")),u.showImage(d,e)},openPopupThumb:function(b){var c=b.attr("data-url");a(l).removeClass("active"),b.addClass("active"),u.showImage(c,""),u.reposition()
...
},resize:function(){var b=a(f),c=a(j),d=b.find(m),e=d.find("img"),g=c.height(),h=e.width(),i=e.height(),k=b.width(),l=b.height(),n=.75*k,o=.75*l-g,p=n/h;targetWidth=h*p,targetHeight=i*p;var q=targetHeight>o;q&&(p=o/i,targetWidth=h*p,targetHeight=i*p),e.css({width:targetWidth,height:targetHeight});var r=d.width(),s=d.height()-g;d.css({top:(l-s)/2-g,left:(k-r)/2})},reposition:function(){var b=a(j),c=a(k),d=a(l+".active"),e=b.width()/2,f=d.position().left+d.width()/2,g=e-f;c.css("left",g)}};a(document).on("click",n,function(){var c=a(this),d=c.attr("href");
"javascript:void(0)"===d&&c.siblings(g).click()}).on("click",g,function(b){if(!(b.shiftKey||b.ctrlKey||b.metaKey)){var c=a(this),d=c.closest(m),e=d.closest(p);e.length?u.openThumbnails(e,d):u.openImage(d),b.stopPropagation(),b.preventDefault()}}).on("click",n,function(b){var c=a(this);if(!c.attr("href")){var d=c.closest(m),e=d.find(g);e.length&&(e.click(),b.stopPropagation(),b.preventDefault())}}).on("click",l,function(b){var c=a(this);u.openPopupThumb(c),b.stopPropagation(),b.preventDefault()}).on("click",h,function(){u.close()
}),b.resolve()}),EasyBlog.module("layout/image/gallery",function(a){var b=this,c=".eb-gallery",d=".eb-gallery-viewport",e=".eb-gallery-item",g=".eb-gallery-next-button",i=".eb-gallery-button",k=".eb-gallery-menu-item",l=EasyBlog.ImageGallery={setLayout:function(b){var c=b.find(e);c.each(function(b){var c=a(this),d=100*b;c.css("left",d+"%")});var d=b.data("autoplay");d&&this.autoplay.start(b)},autoplay:{start:function(a){var b=1e3*a.data("interval");l.autoplay.stop(a);var c=setTimeout(function(){l.next(a),l.autoplay.start(a)
},b);a.data("timer",c)},stop:function(a){var b=a.data("timer");clearTimeout(b)}},checkAutoplay:function(a){var b=1e3*a.data("interval");this.stopMonitoringAutoplay(a),setTimeout(function(){l.next(a),l.startMonitoringAutoplay(a)},b)},go:function(a,b){var c=l.getMenuItems(a).length-1;0>b&&(b=c),b>c&&(b=0),l.setActiveIndex(a,b);var e=a.find(d),f=-100*b;e.css("left",f+"%")},next:function(a){var b=l.getActiveIndex(a),c=b+1;l.go(a,c)},prev:function(a){var b=l.getActiveIndex(a),c=b-1;l.go(a,c)},setActiveIndex:function(a,b){var c=l.getMenuItems(a);
c.removeClass("active").eq(b).addClass("active")},getActiveIndex:function(a){var b=l.getMenuItems(a),c=b.filter(".active").index();return 0>c&&(c=0),c},getMenuItems:function(a){return a.find(k)}};a(document).on("click.eb.gallery.button",i,function(){var d=a(this),e=d.closest(c);if(!(e.length<1)){var f=d.is(g)?"next":"prev";l[f](e)}}).on("click.eb.gallery.menuItem",k,function(){var d=a(this),e=d.closest(c);if(!(e.length<1)){var f=e.find(k).index(d);l.go(e,f)}}).ready(function(){a(c).each(function(){var b=a(this);
l.setLayout(b)})}),b.resolve()}),EasyBlog.module("layout/image/legacy",function(a){function c(a){var b=a.parent(),c=b.css("float");if("none"==c&&(c=a.css("float")),"none"==c){var d=a[0].style;"auto"==d.marginLeft&&"auto"==d.marginRight&&(c="center")}return"none"==c&&(c=b.attr("align"),(void 0===c||"none"==c)&&(c=a.attr("align"))),/none|middle/.test(c)&&(c="center"),c}var b=this,d=".easyblog-thumb-preview img, img.easyblog-image-caption, img[data-popup], img[data-style]";a(document).ready(function(){a(d).each(function(){var b=a(this),d=b.parent(),e=b.attr("src"),f=a('<div class="eb-image">'),g=a('<div class="eb-image-figure">');
...
m||(m=f.document.overlay.create(e),m.placeholder().prependTo(i),m.attach(),e.data("overlay",m)),console.log(m);var n=a.create("iframe"),o=a.rootPath+"/media/index.html";return n.attr("src",o).one("load",function(){var e=n[0].contentWindow,f=e.document,g=f.head,i=f.body,m=j.clone().css(d.css).appendTo(i)[0];e.eval("window.FD50 = window.parent.FD50_PSEUDO;"),a.script({url:c,head:g}).done(function(){console.log(l);var b=e.ace,c=b.edit(m),f=l.theme||j.data("theme")||d.theme,g=l.mode||j.data("mode")||d.mode,h=l.fontsize||j.data("fontsize")||d.fontsize,i=l.show_gutter||j.data("gutter")||d.show_gutter;
...
},populate:function(a){var c=f.data(a);b.alertSelection().where("type",c.type).activateClass("selected")},setAlertType:function(a){var c=f.getBlockContent(h);note=c.find(b.note),note.switchClass("alert-"+a)},previewType:function(a){clearTimeout(b.previewTimer);{var c=f.getBlockContent(h),d=b.note.inside(c),e=d.attr("class");f.getData(h)}h.hasClass("is-preview")||(h.data("originalClass",e),h.addClass("is-preview")),b.setAlertType(a);var i=[h,b,d];b.trigger("composerBlockNotePreviewType",i),b.trigger("composerBlockChange",i)
},previewTimer:null,"{alertSelection} mouseover":function(a){var c=a.data("type");b.previewType(c)},"{alertSelection} mouseout":function(){clearTimeout(b.previewTimer),b.previewTimer=a.delay(function(){var a=h.data("originalClass");a&&b.setAlertType(a),h.removeClass("is-preview"),h.removeData("originalClass")},50)},"{alertSelection} click":function(c){var d=c.data("type"),e=f.data(h);b.alertSelection().removeClass("selected"),a(c).addClass("selected"),h.removeClass("is-preview"),h.removeData("originalClass"),b.setAlertType(d),e.type=d,b.populate(h)
}}}),b.resolve()})}),EasyBlog.module("composer/blocks/handlers/post",function(a){var b=this;EasyBlog.Controller("Composer.Blocks.Handlers.Post",{defaultOptions:{"{block}":".ebd-block[data-type=text]","{wrapper}":"> div[data-text-wrapper]","{lastParagraph}":"> div > p:last","{mediaPreview}":"[data-post-media]","{introPreview}":"[data-post-intro]","{linkPreview}":"[data-post-link-preview]","{titlePreview}":"[data-preview-title]","{showImage}":"[data-post-option-image]","{showIntro}":"[data-post-option-intro]","{showHyperlink}":"[data-post-option-link]"}},function(b,c,d,e,f,g,h){return{init:function(){f=b.blocks,e=f.composer,g=c.meta,h=a()
...
},activateKeys:function(){a(document).off("keydown.blocks.text")},deactivateKeys:function(){a(document).on("keydown.blocks.text",function(a){var b=a.which;return 33==b||34==b?(a.preventDefault(),!1):!0})},activate:function(a){b.deactivateKeys(),h=a,b.populate()},deactivate:function(){b.activateKeys()},construct:function(){var b=f.createBlock("text");return f.getBlockContent(b).html(g.data.content),b},reconstruct:function(c){var d=f.getBlockContent(c),e=b.blockWrapper.inside(d);e.length||(e=a(g.blockWrapper).append(d[0].childNodes).appendTo(d));
var h=b.contentWrapper.inside(d);if(!h.length){var i=[];a.each(e[0].childNodes,function(){a(this).is(EBD.block)||i.push(this)}),h=a(g.contentWrapper).append(i).appendTo(e)}},deconstruct:function(a){var c=f.getBlockContent(a),d=b.contentWrapper.inside(c),e=d[0].childNodes,g=c.find(EBD.immediateNestedBlock);return c.empty().append(g).append(e),a},refocus:function(){},reset:function(){},populate:function(){},recover:function(){},revert:function(){},toText:function(a){var c=a.clone(),d=b.deconstruct(c),e=f.getBlockContent(d).text();
...
f.length||b.trigger("composerDocumentBlur")}}},"{self} composerValidate":function(){}}}),b.resolve()})}),EasyBlog.module("composer/document/toolbar",function(a){var b=this;EasyBlog.Controller("Composer.Document.Toolbar",{elements:["[data-eb-composer-{add-block-button|add-media-button|add-post-button|show-drawer-button}]","[data-eb-composer-{mobile-blip}]"],defaultOptions:{}},function(b,c,d,e){return{init:function(){e=b.document.composer},activate:function(){b.mobileBlip().addClass("show-menu")},deactivate:function(){b.mobileBlip().removeClass("show-menu")
},isActive:function(){return b.mobileBlip().hasClass("show-menu")},"{mobileBlip} click":function(){return b.isActive()?(b.deactivate(),void 0):(b.activate(),void 0)},"{addBlockButton} click":function(){b.deactivate(),e.views.show("blocks")},"{addMediaButton} click":function(){b.deactivate(),e.views.show("media")},"{addPostButton} click":function(){b.deactivate(),e.views.show("posts")},"{showDrawerButton} click":function(){a("[data-eb-composer-frame]").toggleClass("show-drawer")}}}),b.resolve()}),EasyBlog.module("composer/redactor10",function(a){function d(a,b){return new d.prototype.init(a,b)
...
for(h in e){var i=e[h],j=i.length<1,k=b.getFilelist(a,h).toggleClass("is-uploading",!j);j||k.prepend(i)}},"{selectingCancel} click":function(){b.closeMediaManager()},"{browseButton} click":function(a){var d=a.data("eb-mm-filter"),e=a.data("eb-mm-start-uri"),f=b.getUri(e),g=a.data("eb-mm-browse-place");"post"==f&&(f=b.getCurrentPostUri()),b.mode="select",b.currentBrowseButton=a,b.currentBrowseButton.trigger("mediaSelectStart",[b.currentBrowseButton]),b.openMediaManager(f,d),b.frame().switchClass("filter-"+b.currentFilterType),b.frame().addClass("is-selecting"),"local"==g?b.frame().addClass("show-local"):b.frame().removeClass("show-local")
...
})}}})},"{self} mediaFolderDisplay":function(){},"{self} mediaRemove":function(a,c,d){var e=b.getKey(d);b.file().where("key",e).remove(),b.infoViewport().removeClass("active");var f=b.getParent(d),g=b.getFolder(f),h=g.find("[data-eb-mm-file][data-key='"+e+"']");h.remove(),setTimeout(function(){b.info().where("key",e).detach()},500)},"{filegroupShowAllButton} click":function(a){b.filegroup.of(a).addClass("show-all")},revealThumbnails:function(){var c=b.folderContentPanel();if(!(c.length<1)){var d=c.offset().top,e=d+c.height();
b.thumbnail.inside(c).each(function(){var b=a(this);if(!b.is(":hidden")){var c=b.offset().top,f=c+b.height();return f>=d&&e>=c?(b.css("backgroundImage",a.cssUrl(b.data("thumbnail"))).removeAttr("data-thumbnail"),!0):void 0}})}},"{pages} pageslidestop":function(){b.revealThumbnails()},"{folderContentPanel} scrolly":a.debounce(function(){b.revealThumbnails()},150),"{fileInsertButton} click":function(a){var c=b.info.of(a),d=c.data("key"),e=b.getUri(d),f=b.mediaDocument(),g=f.find(EBD.standaloneBlock);b.getMedia(e).done(function(a){"select"==b.mode?(b.currentBrowseButton.trigger("mediaSelect",[a]),i.blocks.panel.fieldgroup.hide()):b.trigger("mediaInsert",[a,g]),b.closeMediaManager()
...
c.helper.css("margin-left",g)}},appendTo:b.ghosts(),connectToSortable:EBD.root})}},"{file} dragstart":function(a){{var d=a.data("key");b.getUri(d)}b.getMedia(d),b.closeMediaManager()},"{closeButton} click":function(){b.closeMediaManager()},"{closeMessageButton} click":function(){b.frame().removeClass("show-foldermove-message show-filemove-message has-messages")}}});a("body").addController(g),b.resolve(g)})}),EasyBlog.module("mediamanager/uploader",function(a){var b=this;EasyBlog.require().library("plupload2").done(function(){EasyBlog.Controller("MediaManager.Uploader",{elements:["[data-eb-mm-{upload-progress|upload-name|upload-size|upload-progress-value|upload-progress-bar}]","[data-eb-mm-upload-{error-text|error-retry}]"],defaultOptions:{}},function(b,c,d,e){return{init:function(){e=b.mediaManager;
var c={runtimes:"html5, html4",autostart:!0},d=e.frame().htmlData("mm-uploader");b.defaultUploadOptions=a.extend(c,d)},instances:{},register:function(c,d){var d=a.extend({},b.defaultUploadOptions,d),f=c.data("key"),g=EasyBlog.MediaManager.getUri(f);"post"==g&&(f=EasyBlog.MediaManager.getKey(EasyBlog.MediaManager.getCurrentPostUri()));var h=d.extensions.split(",");a.each(EasyBlog.MediaManager.options.types,function(b,c){a(c).filter(function(b,c){return a.inArray(c,h)})}),EasyBlog.MediaManager.options.types.file=h;
var i=c.data("type")||"file";d.extensions=EasyBlog.MediaManager.options.types[i].join(","),d.url=a.uri(d.url).replaceQueryParam("key",f).toString();var j=c.plupload2(d,!1),k=j.id;return j.uri=e.getUri(f),j.container=c,b.instances[k]=j,a.each(b.plupload,function(a,d){j.bind(a,function(){d.apply(this,arguments),b.trigger("mediaUploader"+a,arguments),c.trigger("mediaUploader"+a,arguments),b.trigger("mediaUploaderChange",arguments),c.trigger("mediaUploaderChange",arguments)})}),j.init(),j},plupload:{FileFiltered:function(a,b){b.items=[],b.addedDate=(new Date).getTime()
...
},updateAllItems:function(c){c.items&&a.each(c.items,function(a,d){b.updateItem(c,d)})},removeItem:function(b,c){a.pull(b.items,c)}}}),b.resolve()})}),EasyBlog.module("composer/panels/authorship",function(a){var b=this;EasyBlog.Controller("Composer.Panels.Authorship",{defaultOptions:{"{authorArea}":"[data-eb-composer-author]","{currentAuthor}":"[data-eb-composer-current-author]","{searchAssociates}":"[data-associates-search]","{cancelSearchAssociates}":"[data-associates-search-cancel]","{searchAuthor}":"[data-author-search]","{cancelSearchAuthor}":"[data-author-search-cancel]","{tab}":"[data-author-type]","{tabContent}":"[data-tab-content]","{changeAuthor}":"[data-eb-composer-switch-author]","{authorPicker}":"[data-eb-composer-author-picker]","{authorItem}":"[data-eb-author-item]","{authorList}":"[data-eb-composer-author-list]","{authorCheckbox}":"[data-eb-composer-authoritem]","{activeAuthorId}":"[data-eb-composer-authorid]","{activeAuthorAvatar}":"[data-eb-composer-authoravatar]","{activeAuthorName}":"[data-eb-composer-authorname]","{associatesList}":"[data-eb-composer-associates-list]","{associateItem}":"[data-associates-item]","{associateCheckbox}":"[data-associates-checkbox]","{activeAssociateName}":"[data-eb-composer-associatename]","{activeAssociateId}":"[data-eb-composer-associateid]","{activeAssociateType}":"[data-eb-composer-associatetype]","{activeAssociateAvatar}":"[data-eb-composer-associateavatar]"}},function(b){return{init:function(){},"{cancelSearchAssociates} click":function(){b.associateItem().removeClass("hide"),b.searchAssociates().val("")
},"{cancelSearchAuthor} click":function(){b.authorItem().removeClass("hide"),b.searchAuthor().val("")},"{searchAssociates} keydown":a.debounce(function(c){var e=a.trim(c.val()).toLowerCase();if(!e)return b.associateItem().removeClass("hide"),void 0;var f=b.associateItem().filter(function(){var b=a.trim(a(this).data("title")).toLowerCase();return 0==b.indexOf(e)?!0:!1});f&&(b.associateItem().addClass("hide"),f.removeClass("hide"))},300),"{searchAuthor} keydown":a.debounce(function(c){var e=a.trim(c.val()).toLowerCase();
if(!e)return b.authorItem().removeClass("hide"),void 0;var f=b.authorItem().filter(function(){var b=a.trim(a(this).data("title")).toLowerCase();return 0==b.indexOf(e)?!0:!1});f&&(b.authorItem().addClass("hide"),f.removeClass("hide"))},300),associatesLoaded:!1,"{tab} click":function(a){var d=a.data("type");"associates"==d&&b.loadAssociates(),b.tab().removeClass("active"),b.tab().where("type",d).addClass("active"),b.tabContent().removeClass("active"),b.tabContent().where("type",d).addClass("active")},"{changeAuthor} click":function(){return b.authorArea().toggleClass("is-opened"),b.authorPicker().toggleClass("pulled"),1==b.tab().length?(b.loadAssociates(),void 0):(EasyBlog.ajax("site/views/composer/listAuthors",{selected:b.activeAuthorId().val()}).done(function(a){b.authorList().html(a)
}),void 0)},loadAssociates:function(){b.associatesLoaded||EasyBlog.ajax("site/views/composer/listAssociates",{source_id:b.activeAssociateId().val(),source_type:b.activeAssociateType().val()}).done(function(a){b.associatesLoaded=!0,b.associatesList().html(a)})},"{authorCheckbox} change":function(a){var d=a.parents(b.authorItem.selector).data("avatar"),e=a.parents(b.authorItem.selector).data("id"),f=a.parents(b.authorItem.selector).data("title");b.setActiveAuthor(e,f,d)},"{associateCheckbox} change":function(a){var d=a.parents(b.associateItem.selector).data("avatar"),e=a.parents(b.associateItem.selector).data("id"),f=a.parents(b.associateItem.selector).data("title"),g=a.parents(b.associateItem.selector).data("type");
...
var d="green";/error|danger/.test(c.type)&&(d="red"),/success/.test(c.type)&&(d="green"),b.messages().switchClass("style-"+d),b.messages().find("[data-message]").html(c.message)})},"{closeMessage} click":function(){b.manager().removeClass("has-messages")},"{previewPostButton} click":function(){b.publishedField().val(e),b.save().done(function(a,b,c,d,e){window.open(e)})},"{savePostButton} click":function(a){b.publishedField().val(e),a.addClass("is-saving"),b.save({autosave:1,isapply:0}).done(function(){a.removeClass("is-saving")
})},"{submitPostButton} click":function(){b.disableLeavePrompt(),b.publishedField().val(f),b.save({autosave:0,isapply:0})},"{approvePostButton} click":function(a){b.publishedField().val(g),a.addClass("is-saving"),b.disableLeavePrompt(),b.save({autosave:0,isapply:0}).done(function(){a.removeClass("is-saving")})},"{publishPostButton} click":function(a){b.publishedField().val(g),a.addClass("is-saving"),b.disableLeavePrompt(),b.save({autosave:0,isapply:0}).done(function(){}).always(function(){a.removeClass("is-saving")
})},"{applyPostButton} click":function(a){b.publishedField().val(g),a.addClass("is-saving"),b.save({autosave:0,isapply:1}).done(function(){}).always(function(){a.removeClass("is-saving")})},"{updatePostButton} click":function(a){b.publishedField().val(g),b.disableLeavePrompt(),a.addClass("is-saving"),b.save({autosave:0,isapply:0}).done(function(){a.removeClass("is-saving")})},"{unpublishPostButton} click":function(){b.publishedFiled().val(i),b.save({autosave:0,isapply:0})},"{deletePostButton} click":function(){b.trash()
},"{self} composerSelectTemplate":function(){setTimeout(function(){b.autosave.start()},5e3)},"{savingEntryButton} click":function(){b.disableLeavePrompt();var a=b.savingEntryButton().attr("href");EasyBlog.ComposerLauncher.redirect(a)},"{savingCloseButton} click":function(){b.manager().removeClass("is-saving")},initSaving:function(a){a?b.manager().addClass("is-auto-saving"):(b.manager().removeClass("is-auto-saving"),b.savingEntryButton().addClass("hide"),b.savingCloseButton().addClass("hide"),b.savingProgressBar().removeClass("hide"),b.savingInfoMessage().text(""),b.savingInfoMessage().addClass("hide"),b.savingMessage().removeClass("hide"),b.manager().addClass("is-saving"))
