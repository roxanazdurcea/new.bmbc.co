...
})}}}}),b.resolve()})}),EasyBlog.module("dashboard/categories",function(){var b=this;EasyBlog.require().script("dashboard/form").done(function(a){EasyBlog.Controller("Dashboard.Categories",{defaultOptions:{"{item}":"[data-eb-category-item]","{create}":"[data-eb-categories-create]"}},function(a){return{init:function(){a.element.implement(EasyBlog.Controller.Dashboard.Form),a.item().implement(EasyBlog.Controller.Dashboard.Categories.Item)},"{create} click":function(){EasyBlog.dialog({content:EasyBlog.ajax("site/views/dashboard/categoryForm")})
}}}),EasyBlog.Controller("Dashboard.Categories.Item",{defaultOptions:{id:null,"{action}":"[data-action]"}},function(b){return{init:function(){b.options.id=b.element.data("id")},showDialog:function(a){EasyBlog.dialog({content:EasyBlog.ajax(a,{ids:[b.options.id]}),bindings:{"{submitButton} click":function(){this.form().submit()}}})},"{action} click":function(c){var e=a(c).data("type"),f=a(c).data("action");"dialog"==e&&b.showDialog(f)}}}),b.resolve()})}),EasyBlog.module("dashboard/form",function(a){var b=this;
EasyBlog.Controller("Dashboard.Form",{defaultOptions:{"{checkAll}":"[data-eb-form-checkall]","{actions}":"[data-eb-form-actions]","{checkboxes}":"[data-eb-form-checkbox]","{applyButton}":"[data-eb-form-apply]","{taskSelection}":"[data-eb-form-task]","{taskInput}":"[data-table-grid-task]","{filter}":"[data-eb-form-filter]","{search}":"[data-eb-form-search]"}},function(b){return{init:function(){},submitForm:function(){b.element.submit()},getSelectedCheckboxes:function(){var c=[],d=b.checkboxes(":checked");return d.each(function(b,d){c.push(a(d).val())
}),c},"{checkboxes} change":function(){var d=b.checkboxes(":checked").length>0;d?b.actions().removeClass("hide"):b.actions().addClass("hide")},"{search} click":function(){b.submitForm()},"{filter} click":function(){b.taskInput().val(""),b.submitForm()},"{applyButton} click":function(){var d=b.taskSelection().val(),e=b.taskSelection().find(":selected").data("confirmation");if(""==d)return!1;if(e){var f=this.getSelectedCheckboxes();return f.length<=0?!1:(EasyBlog.dialog({content:EasyBlog.ajax(e,{ids:f}),bindings:{"{submitButton} click":function(){b.taskInput().val(d),b.submitForm()
}}}),!1)}b.taskInput().val(d),b.element.submit()},"{checkAll} change":function(){var d=b.checkAll().is(":checked");d?b.actions().removeClass("hide"):b.actions().addClass("hide"),b.checkboxes().prop("checked",d)}}}),b.resolve()}),EasyBlog.module("dashboard/comments",function(){var b=this;EasyBlog.require().script("dashboard/form").done(function(a){EasyBlog.Controller("Dashboard.Comments",{defaultOptions:{"{item}":"[data-eb-comment-item]"}},function(a){return{init:function(){a.element.implement(EasyBlog.Controller.Dashboard.Form),a.item().implement(EasyBlog.Controller.Dashboard.Comments.Item)
