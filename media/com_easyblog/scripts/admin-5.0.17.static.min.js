...
}}})}),b.resolve()}),EasyBlog.module("admin/grid",function(){var b=this;EasyBlog.require().script("admin/sort","admin/publishing").done(function(a){EasyBlog.Controller("Grid",{defaultOptions:{"{sortColumns}":"[data-table-grid-sort]","{ordering}":"[data-table-grid-ordering]","{direction}":"[data-table-grid-direction]","{task}":"[data-table-grid-task]","{searchInput}":"[data-table-grid-search-input]","{search}":"[data-table-grid-search]","{resetSearch}":"[data-table-grid-search-reset]","{checkAll}":"[data-table-grid-checkall]","{checkboxes}":"[data-table-grid-id]","{publishItems}":"[data-table-grid-publishing]","{itemRow}":"tr","{boxChecked}":"[data-table-grid-box-checked]","{filters}":"[data-table-grid-filter]"}},function(b){return{init:function(){b.implementSortable(),b.implementPublishing()
},"{filters} change":function(){b.setTask(""),b.submitForm()},"{search} click":function(){b.submitForm()},"{resetSearch} click":function(){b.searchInput().val(""),b.submitForm()},submitForm:function(){b.element.submit()},setTask:function(a){b.task().val(a)},setOrdering:function(a){b.ordering().val(a)},setDirection:function(a){b.direction().val(a)},setTotalChecked:function(a){b.boxChecked().val(a)},toggleSelectRow:function(b){var c=b.find("input[name=cid\\[\\]]");1==a(c).prop("checked")?a(c).prop("checked",!1):a(c).prop("checked",!0)
},selectRow:function(b){var c=b.find("input[name=cid\\[\\]]");a(c).prop("checked",!0)},implementSortable:function(){b.sortColumns().implement(EasyBlog.Controller.Grid.Sort,{"{parent}":b})},implementPublishing:function(){b.publishItems().implement(EasyBlog.Controller.Grid.Publishing,{"{parent}":b})},"{checkAll} change":function(c){b.checkboxes().prop("checked",a(c).is(":checked"));var e=a(c).is(":checked")?b.checkboxes().length:0;b.setTotalChecked(e)}}}),b.resolve()})}),EasyBlog.module("admin/sort",function(){var b=this;
EasyBlog.Controller("Grid.Sort",{defaultOptions:{items:"[data-grid-sort-item]"}},function(a){return{init:function(){},"{self} click":function(){var b=a.element.data("direction"),c=a.element.data("sort");a.parent.setOrdering(c),a.parent.setDirection(b),a.parent.setTask(""),a.parent.submitForm()}}}),b.resolve()}),EasyBlog.module("admin/publishing",function(){var b=this;EasyBlog.Controller("Grid.Publishing",{defaultOptions:{}},function(a){return{init:function(){},"{self} click":function(){var c=a.element.parents("tr"),d=a.element.data("task");
a.parent.selectRow(c),a.parent.setTask(d),a.parent.submitForm()}}}),b.resolve()}),EasyBlog.module("admin/maintenance/database",function(){var b=this;EasyBlog.Controller("Maintenance.Database",{defaultOptions:{"{start}":"[data-start]","{progress}":"[data-progress]","{progressBox}":"[data-progress-box]","{progressBar}":"[data-progress-bar]","{progressPercentage}":"[data-progress-percentage]","{errorBox}":"[data-error]","{successBox}":"[data-success]"}},function(a){return{init:function(){},"{start} click":function(b){b.hide(),a.progress().show(),a.process()
},counter:0,versions:[],process:function(){a.getStats().done(function(b){a.versions=b,a.execute()})},getStats:function(){return EasyBlog.ajax("admin/controllers/maintenance/getDatabaseStats")},execute:function(){return void 0===a.versions[a.counter]?a.completed():(a.successBox().hide(),EasyBlog.ajax("admin/controllers/maintenance/synchronizeDatabase",{version:a.versions[a.counter]}).fail(function(b){a.errorBox().show(),a.errorBox().append('<div class="alert alert-danger">'+b+"</div>")}).always(function(){a.counter++;
var b=Math.floor(a.counter/a.versions.length*100)+"%";a.progressBar().css("width",b),a.progressPercentage().text(b),a.execute()}),void 0)},completed:function(){a.progressBar().css("width","100%"),a.progressPercentage().text("100%"),a.progressBox().removeClass("progress-info").addClass("progress-success"),a.successBox().delay(1e3).fadeIn(400)}}}),b.resolve()}),EasyBlog.module("admin/maintenance/form",function(){var b=this;EasyBlog.Controller("Maintenance.Form",{defaultOptions:{"{row}":"[data-row]"}},function(a){return{init:function(){a.runscript()
},counter:0,success:0,fail:0,runscript:function(){var b=a.row().eq(a.counter);if(0===b.length)return a.completed();var c=b.data("key");EasyBlog.ajax("admin/controllers/maintenance/runscript",{key:c}).done(function(){a.setStatus(b,1),a.success++}).fail(function(){a.setStatus(b,0),a.fail++}).always(function(){a.counter++,a.runscript()})},completed:function(){a.fail<1&&(window.location="index.php?option=com_easyblog&view=maintenance&success="+a.success)},setStatus:function(a,b){var c=a.find("[data-status]"),d=a.find("[data-icon]"),e=["label-danger","label-success","label-warning"],f=["ies-warning-2","ies-checkmark","ies-wrench-3"];
for(i=0;3>i;i++)c.toggleClass(e[i],b==i),d.toggleClass(f[i],b==i)}}}),b.resolve()}),EasyBlog.module("admin/grid/ordering",function(a){var b=this;EasyBlog.Controller("Grid.Ordering",{defaultOptions:{"{moveUp}":"[data-grid-order-up]","{moveDown}":"[data-grid-order-down]",row:null}},function(b){return{init:function(){b.options.row=b.element.parents("tr")},selectRow:function(){var c=b.options.row.find("input[name=cid\\[\\]]");a(c).prop("checked",!0)},"{moveUp} click":function(){b.selectRow(),a.Joomla("submitform",["moveUp"])
},"{moveDown} click":function(){b.selectRow(),a.Joomla("submitform",["moveDown"])}}}),b.resolve()})});