...
class FD50_FoundryFramework {
	...
	public static function defineFrameworkConstants($className='', $ns=null) {
		...
		define($NS.'BOOTCODE'    , 'FD50');
		define($NS.'VERSION'     , '5.0');
		define($NS.'LONG_VERSION', '5.0.9');
	...
	public static function defineComponentConstants($className='', $ns=null) {
		...
		// Foundry
		define($NS.'FOUNDRY_VERSION'      , '5.0' );
		define($NS.'FOUNDRY_LONG_VERSION' , '5.0.9');
		define($NS.'FOUNDRY_BOOTCODE'     , 'FD50' );
...
FD50_FoundryFramework::defineFrameworkConstants('Foundry', 'FD50_FOUNDRY_');
