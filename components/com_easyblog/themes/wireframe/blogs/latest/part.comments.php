		...
		<div class="eb-post-comment">
			...
			<div class="eb-post-comment-content">
				<div class="eb-post-comment-author">
					<a href="<?php echo $comment->getAuthor()->getPermalink();?>"><b><?php echo $comment->getAuthor()->getName(); ?></b></a>
				</div>
				...
				<div class="eb-post-comment-text">
					<?php if (JString::strlen($comment->comment) > 130) { ?>
						<?php echo JString::substr(strip_tags(EB::comment()->parseBBCode($comment->comment)), 0, 130); ?>
					<?php } else { ?>
