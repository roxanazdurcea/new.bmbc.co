...
?>
<div class="eb-composer-toolbar-set row-table" data-name="messages" data-eb-composer-toolbar-messages>
    ...
    <div class="col-cell cell-tight toolbar-right">
        <div class="eb-composer-toolbar-group row-table">
            <div class="eb-composer-toolbar-item is-button col-cell" data-eb-composer-close-message>
