...
<form name="seo" class="eb-composer-seo" data-eb-composer-form>
    <div class="eb-composer-fieldset">
        ...
        <div class="eb-composer-fieldset-content">
            <input class="form-control" type="text" id="robots" name="robots" value="<?php echo $this->html('string.escape', $post->robots);?>" placeholder="<?php echo JText::_('COM_EASYBLOG_COMPOSER_ROBOTS_PLACEHOLDER', true);?>" />
        </div>
    </div>
