    ...
    <div class="row-table">
        <div class="col-cell">
            <div class="btn-group dropup">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                    ...
                    <li class="eb-composer-save-template-button" data-eb-composer-save-post-button>
                        <a href="javascript:void(0);">
                    ...
                    <li class="eb-composer-unpublish-post-button" data-eb-composer-unpublish-post-button>
                        <a href="javascript:void(0);">
                            <i class="fa"></i>&nbsp; <?php echo JText::_('COM_EASYBLOG_COMPOSER_UNPUBLISH_POST_BUTTON'); ?>
                        </a>
                    </li>
                    <?php } ?>
        ...
        <div class="col-cell pl-10">
            <a class="btn btn-default eb-composer-apply-post-button" data-eb-composer-apply-post-button>
                ...
                <i class="fa fa-send"></i>&nbsp; <?php echo JText::_('Apply'); ?>
            </a>
        </div>
