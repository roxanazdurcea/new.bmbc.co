    ...
    <div class="eb-composer-fieldset-content">
    	<div class="eb-composer-field">
            <div class="eb-composer-manage-tabs" data-columns-control
                ...
                data-listbox-itemTitle="<?php echo JText::_('Select Colums');?>"
                data-listbox-max="6"
                data-listbox-min="2"
            >
                ...
                <div data-listbox-custom-html style="display:none;">
                    <div class="col-cell no-wrap" style="padding-right: 10px;"><?php echo JText::_('Column Size'); ?></div>
                    <div class="col-cell">
                        <select data-select-width>
                            <option><?php echo JText::_('Select Size'); ?></option>
