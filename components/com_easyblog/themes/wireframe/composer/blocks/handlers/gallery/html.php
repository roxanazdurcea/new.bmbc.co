...
<div class="eb-gallery is-empty">
        ...
        <div class="eb-gallery-viewport">
            <div class="eb-gallery-item is-placeholder">
                <div class="eb-composer-placeholder-content" >
                    ...
                    <b class="eb-composer-placeholder-title"><?php echo JText::_('Gallery');?></b>
                    <p class="eb-composer-placeholder-brief"><?php echo JText::_('Upload multiple images to create gallery.');?></p>
                    <p data-eb-file-error class="hide eb-composer-placeholder-error text-error"><?php echo JText::_('Invalid file');?></p>
    ...
    <div class="eb-gallery-menu"><div class="eb-gallery-menu-item is-placeholder active"><div></div></div></div>
