	...
	<div class="eb-post-content">
		<div class="eb-post-head">
			...
			<div class="eb-placeholder-quote">
				<h2 itemprop="name headline" class="eb-placeholder-quote-text eb-post-title reset-heading">
					<a href="<?php echo $blog->getPermalink();?>"><?php echo nl2br($blog->title);?></a>
				</h2>
				<div class="eb-placeholder-quote-source"><?php echo $blog->text;?></div>
			</div>
			<?php } ?>
