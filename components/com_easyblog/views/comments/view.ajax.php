...
class EasyBlogViewComments extends EasyBlogView
{
	...
	public function save()
	{
		...
		if ((!$this->acl->get('allow_comment') ) && !$this->my->id && !$this->config->get('main_allowguestcomment')) {
	...
	public function confirmDelete()
	{
		...
		$return = base64_encode($blog->getPermalink(false));
