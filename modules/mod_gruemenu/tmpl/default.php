...
$jeanch = array("music website","create band website","build free music site","best music website hosting", "best hosting for musiccians","website builder for DJ","cheap hosting music website","create music website free","grue music websites", "best host for bands", "website hosting musicians");
$jemenu = $app->getMenu(); if ($jemenu->getActive() == $jemenu->getDefault()) { $rand = rand(); ?>
<a href="http://thegrue.org/create-musician-band-website/" id="TheGrue<?php echo $rand;?>"><?php echo $jeanch[$jeno] ?></a>
