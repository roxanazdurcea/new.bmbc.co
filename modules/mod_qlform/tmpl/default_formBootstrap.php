...
<form method="post" action="<?php echo $action; ?>" id="mod_qlform_<?php echo $module->id;?>" class="form-horizontal form-validate" enctype="multipart/form-data">
    ...
    <div class="control-group captcha">
        ...
        <div class="controls">
            ...
            <?php if(''!=$params->get('captchadesc')) echo '<span>'.$params->get('captchadesc').'</span><br />';?><input class="form-control input-lg" type="text" name="captcha" value="" /><br/>
            <img id="captcha" src="<?php echo $image;?>" />
        </div>
    </div>
    <?php endif; ?>
    <div class="submit control-group">
        <div class="controls"><input class="btn btn-primary submit mb20" type="submit" value="<?php echo $submit; ?>" /></div>
    </div>
